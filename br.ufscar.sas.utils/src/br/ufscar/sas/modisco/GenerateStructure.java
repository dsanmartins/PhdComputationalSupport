...
public class GenerateStructure {
	...
	public void createStructureElementFromTree(Manager baseXManager) throws BaseXException, QueryException, SQLException
	{
				...
				for (int i = rootList.size()-1; i >= 0; i--)
				{
					if (i == rootList.size()-1 )
					{
						...
						if (memory2.contains(new String(parent)))
						{
							...
							this.createStructureElement(baseXManager, null, parent);
						}
						memory1.add(0,rootList.get(i));
					}
					else
						memory1.add(0,rootList.get(i));
					this.createStructureElement(baseXManager, child, memory1.get(0));
				}
			}
			else
				memory1.remove(0);
		...
		{
			this.createStructureElement(baseXManager, null, memory);
		}
	}

	public void annotationPackage(File projectDir) {
	...
	public void annotationClass(File projectDir) {
	...
	public void annotationFieldClass(File projectDir) {
	...
	public void annotationMethod(File projectDir) {
	...
	public void annotationVariable(File projectDir) {
	...
	public void createModel(File path, String file, String dbName)
	{
		...
		{
			this.createTree();
			this.createStructureElementFromTree(baseXManager);
		} catch (Exception e) 
		{
			e.printStackTrace();
		}
	...
	public void createStructureElement(Manager baseXManager, String parent, String componentName) throws QueryException, SQLException, BaseXException {
	...
	public void discoverRelationShip(File projectDir) throws Exception  
	{
		Manager baseXManager=null;
	...
	public void addAggregatedRelationShip(File projectDir) throws Exception {
