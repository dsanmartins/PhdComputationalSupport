...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DSL Monitor Belongs To2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLMonitorBelongsTo2Impl#getMonitor <em>Monitor</em>}</li>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLMonitorBelongsTo2Impl#getManaging <em>Managing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DSLMonitorBelongsTo2Impl extends DSLCompositionImpl implements DSLMonitorBelongsTo2
{
  /**
   ...
   * @generated
   */
  protected DSLMonitorBelongsTo2Impl()
  {
    super();
  }
  ...
  {
    return SasDslPackage.Literals.DSL_MONITOR_BELONGS_TO2;
  }
    ...
    if (monitor != null && monitor.eIsProxy())
    {
      ...
      if (monitor != oldMonitor)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_MONITOR_BELONGS_TO2__MONITOR, oldMonitor, monitor));
      }
    }
    return monitor;
  }
  ...
  public void setMonitor(DSLMonitor newMonitor)
  {
    ...
    monitor = newMonitor;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_MONITOR_BELONGS_TO2__MONITOR, oldMonitor, monitor));
  }
  ...
  public DSLManaging getManaging()
  {
    if (managing != null && managing.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_MONITOR_BELONGS_TO2__MANAGING, oldManaging, managing));
      }
    }
    return managing;
  }
  ...
  public void setManaging(DSLManaging newManaging)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_MONITOR_BELONGS_TO2__MANAGING, oldManaging, managing));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SasDslPackage.DSL_MONITOR_BELONGS_TO2__MONITOR:
        if (resolve) return getMonitor();
        return basicGetMonitor();
      case SasDslPackage.DSL_MONITOR_BELONGS_TO2__MANAGING:
