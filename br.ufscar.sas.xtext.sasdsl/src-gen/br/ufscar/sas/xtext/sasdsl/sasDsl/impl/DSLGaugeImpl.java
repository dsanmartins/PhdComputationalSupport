 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLGaugeImpl#getManaged <em>Managed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DSLGaugeImpl extends DSLAbstractionsImpl implements DSLGauge
{
    ...
    if (managed != null && managed.eIsProxy())
    {
      ...
      if (managed != oldManaged)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_GAUGE__MANAGED, oldManaged, managed));
      }
    }
    return managed;
  }
  ...
  public void setManaged(DSLManaged newManaged)
  {
    ...
    managed = newManaged;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_GAUGE__MANAGED, oldManaged, managed));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SasDslPackage.DSL_GAUGE__MANAGED:
