...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DSL Knowledge Belongs To</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLKnowledgeBelongsToImpl#getKnowledge <em>Knowledge</em>}</li>
 *   <li>{@link br.ufscar.sas.xtext.sasdsl.sasDsl.impl.DSLKnowledgeBelongsToImpl#getManaging <em>Managing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DSLKnowledgeBelongsToImpl extends DSLCompositionImpl implements DSLKnowledgeBelongsTo
{
  /**
   ...
   * @generated
   */
  protected DSLKnowledgeBelongsToImpl()
  {
    super();
  }
  ...
  {
    return SasDslPackage.Literals.DSL_KNOWLEDGE_BELONGS_TO;
  }
    ...
    if (knowledge != null && knowledge.eIsProxy())
    {
      ...
      if (knowledge != oldKnowledge)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_KNOWLEDGE_BELONGS_TO__KNOWLEDGE, oldKnowledge, knowledge));
      }
    }
    return knowledge;
  }
  ...
  public void setKnowledge(DSLKnowledge newKnowledge)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_KNOWLEDGE_BELONGS_TO__KNOWLEDGE, oldKnowledge, knowledge));
  }
  ...
  public DSLManaging getManaging()
  {
    if (managing != null && managing.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SasDslPackage.DSL_KNOWLEDGE_BELONGS_TO__MANAGING, oldManaging, managing));
      }
    }
    return managing;
  }
  ...
  public void setManaging(DSLManaging newManaging)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SasDslPackage.DSL_KNOWLEDGE_BELONGS_TO__MANAGING, oldManaging, managing));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SasDslPackage.DSL_KNOWLEDGE_BELONGS_TO__KNOWLEDGE:
        if (resolve) return getKnowledge();
        return basicGetKnowledge();
      case SasDslPackage.DSL_KNOWLEDGE_BELONGS_TO__MANAGING:
