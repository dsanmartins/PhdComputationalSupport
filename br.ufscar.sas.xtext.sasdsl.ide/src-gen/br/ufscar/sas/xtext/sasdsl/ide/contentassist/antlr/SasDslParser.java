		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDSLCompositionsAccess().getGroup(), "rule__DSLCompositions__Group__0");
					...
					put(grammarAccess.getArchitectureDefinitionAccess().getCompositionsAssignment_5(), "rule__ArchitectureDefinition__CompositionsAssignment_5");
					put(grammarAccess.getArchitectureDefinitionAccess().getDslRestrictionsAssignment_8(), "rule__ArchitectureDefinition__DslRestrictionsAssignment_8");
					...
					put(grammarAccess.getDSLCompositionsAccess().getSensorAssignment_0(), "rule__DSLCompositions__SensorAssignment_0");
					put(grammarAccess.getDSLCompositionsAccess().getMustBeInAssignment_1(), "rule__DSLCompositions__MustBeInAssignment_1");
					put(grammarAccess.getDSLCompositionsAccess().getMonitorAssignment_2(), "rule__DSLCompositions__MonitorAssignment_2");
					...
					put(grammarAccess.getMustBeInAccess().getMustBeInAssignment(), "rule__MustBeIn__MustBeInAssignment");
